          ...
          <div className="col-lg-5">
            <div className="contact__left-item primary-bg">
              ...
              <p className="text-white">
                Whether you need guidance, support, or want to start a new
                project, our team is ready to help. Let us know how we can
                assist you and we’ll respond promptly.
              </p>
              <ul className="mt-40 mb-40">
                <li>
                  ...
                  <div>
                    ...
                    <h3 className="mt-1">
                      <Link className="text-white" href="tel:+639277757470">
                        +63 927 775 7470
                      </Link>
                    </h3>
                  </div>
                  ...
                  <div>
                    ...
                    <h3 className="mt-1">
                      <Link className="text-white" href="/">
                        ironpeaktechnologies@gmail.com
                      </Link>
                    </h3>
                  </div>
                </li>
            ...
            <div className="contact__right-item">
              <div className="section-header mb-20">
                ...
                <p
                  ...
                  data-aos-duration="1500"
                >
                  We’re here to support your business with reliable IT
                  solutions, expert guidance, and responsive service.
                </p>
              </div>
